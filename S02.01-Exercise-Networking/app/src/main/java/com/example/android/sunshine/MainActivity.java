...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationEntry = (EditText) findViewById(R.id.et_location_data);
    ...
    private void loadWeatherData() {
        String wQuery = "94043,USA";//mLocationEntry.getText().toString();//SunshinePreferences.getPreferredWeatherLocation();

        URL githubSearchUrl = NetworkUtils.buildUrl(wQuery);
    ...
    public class FetchWeatherTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... params) {
            ...
            try {
                forecastSearchResults = NetworkUtils.getResponseFromHttpUrl(searchUrl);
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        protected void onPostExecute(String forecastSearchResults) {
            if (forecastSearchResults != null && !forecastSearchResults.equals("")) {
                mWeatherTextView.setText(forecastSearchResults);
            }
        }
    }
